...
function postfilter($msg) {
	...
	$msg = preg_replace("'((\[youtube\])|(\[yt\])){1}((https?\:\/\/)?(www\.)?(youtube\.com|youtu\.?be)\/(watch\?v=)?)?([\-0-9_a-zA-Z]{11}?)((\[\/youtube\])|(\[\/yt\])){1}si", '<iframe width="427" height="240" src="https://www.youtube.com/embed/\\9" frameborder="0" allowfullscreen></iframe>', $msg);
